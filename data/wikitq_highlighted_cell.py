...
class WikiTQHighlightedCellsDataset(Dataset):

    def __init__(self, dataset, config, data_type):
        super(WikiTQHighlightedCellsDataset, self).__init__()
        ...
        if self.data_type == "train":
            with open("datasets/wiki_tq_train_highlighted_cell.pkl", "rb") as f:
                self.highlighted_cells = pickle.load(f)

        elif self.data_type == "test":
            with open("datasets/wiki_tq_test_highlighted_cell.pkl", "rb") as f:
                self.highlighted_cells = pickle.load(f)

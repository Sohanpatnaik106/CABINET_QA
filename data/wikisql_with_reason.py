...
class WikiSQLWithReasonAsInputDataset(Dataset):

    def __init__(self, dataset, config, data_type):
        super(WikiSQLWithReasonAsInputDataset, self).__init__()
        ...
        if self.data_type == "train":
            ...
            with open("datasets/test_wikisql_reason_without_answer_flant5.pkl", "rb") as f:
                self.reasons = pickle.load(f)
        else:

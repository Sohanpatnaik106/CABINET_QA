...
class FetaQAWithReasonAsInputDataset(Dataset):

    def __init__(self, dataset, config, data_type):
        super(FetaQAWithReasonAsInputDataset, self).__init__()
        ...
        if self.data_type == "train":
            with open("datasets/feta_qa_reason_without_answer_flant5.pkl", "rb") as f:

...
class SequentialQAHighlightedCellsDataset(Dataset):

    def __init__(self, dataset, config, data_type):
        super(SequentialQAHighlightedCellsDataset, self).__init__()
        ...
        if self.data_type == "train":
            with open("datasets/seq_qa_train_highlighted_cell_no_history.pkl", "rb") as f:
                self.highlighted_cells = pickle.load(f)

        elif self.data_type == "test":
            with open("datasets/seq_qa_test_highlighted_cell_no_history.pkl", "rb") as f:
                self.highlighted_cells = pickle.load(f)

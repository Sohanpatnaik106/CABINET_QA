...
class TapexTokenizer(PreTrainedTokenizer):
    ...
    def _encode_plus(
        ...
        **kwargs,
        ...
        # NOTE: Implement the computation of row ids, column ids and segment ids code here, 
        # send it to prepare_for_model function by adding additional arguments
    ...
    def prepare_for_model(
        ...
        **kwargs,
        ...
        if isinstance(truncation, bool):
            if truncation:
                truncation = TapexTruncationStrategy.DROP_ROWS_TO_FIT
            else:
                truncation = TapexTruncationStrategy.DO_NOT_TRUNCATE
        elif not isinstance(truncation, TapexTruncationStrategy):
        ...
        num_rows = self._get_num_rows(table, truncation != TapexTruncationStrategy.DO_NOT_TRUNCATE)
        ...
        if truncation != TapexTruncationStrategy.DO_NOT_TRUNCATE:

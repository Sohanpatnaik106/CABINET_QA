...
def get_args(argv):
    ...
    parser.add_argument('--use_pretrain', type=str, default='DEBERTA_V3_CLASS', choices=["BERT", "SBERT", "PAIRSUPCON", "DEBERTA_V3_CLASS"])
    
    # Dataset
    parser.add_argument('--datapath', type=str, default='./datasets')
    parser.add_argument('--dataname', type=str, default='wikitq_train', help="")
    parser.add_argument('--num_classes', type=int, default=5, help="")
    parser.add_argument('--max_length', type=int, default=64)
    parser.add_argument('--label', type=str, default='label')
    parser.add_argument('--text', type=str, default='question')
    parser.add_argument('--augmentation_1', type=str, default='augmentation1')
    parser.add_argument('--augmentation_2', type=str, default='augmentation2')
    # Learning parameters
